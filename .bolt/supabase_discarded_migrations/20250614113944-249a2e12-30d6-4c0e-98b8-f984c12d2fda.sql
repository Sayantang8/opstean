...
('Paracetamol 650mg', 'General Segment', 'Pain reliever and fever reducer', 12.75, 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400', 'MediCore', '650mg', 'Paracetamol', 'Take 1-2 tablets every 4-6 hours as needed', 'Rare: skin rash, liver damage with overdose', 'Do not exceed 8 tablets in 24 hours', false, true),
('Omeprazole 20mg', 'Gastro', 'Proton pump inhibitor for acid reflux and ulcers', 45.00, 'https://images.unsplash.com/photo-1550572017-edd951aa8702?w=400', 'GastroMed', '20mg', 'Omeprazole magnesium', 'Take one tablet daily before breakfast', 'Headache, nausea, stomach pain', 'Long-term use may affect bone density', false, true),
...
('Cetirizine 10mg', 'General Segment', 'Antihistamine for allergies and hay fever', 18.50, 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400', 'AllergyFree', '10mg', 'Cetirizine hydrochloride', 'Take one tablet daily, preferably in the evening', 'Drowsiness, dry mouth, fatigue', 'Avoid alcohol while taking this medication', false, false),
('Metformin 500mg', 'General Segment', 'Diabetes medication to control blood sugar', 22.00, 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=400', 'DiabetCare', '500mg', 'Metformin hydrochloride', 'Take with meals as prescribed', 'Nausea, stomach upset, metallic taste', 'Monitor blood sugar levels regularly', true, true),
...
('Calcium + Vitamin D3', 'General Segment', 'Bone health supplement', 32.50, 'https://images.unsplash.com/photo-1550572017-edd951aa8702?w=400', 'BoneStrong', '500mg + 250 IU', 'Calcium carbonate, Cholecalciferol', 'Take one tablet daily with food', 'Constipation, gas, kidney stones (rare)', 'Consult doctor if history of kidney stones', false, false),
...
('Ibuprofen 400mg', 'General Segment', 'Anti-inflammatory pain reliever', 19.75, 'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=400', 'PainRelief Co', '400mg', 'Ibuprofen', 'Take with food, maximum 3 times daily', 'Stomach irritation, heartburn', 'Avoid if allergic to NSAIDs', false, false),
