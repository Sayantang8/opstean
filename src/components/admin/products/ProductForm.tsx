    ...
    <div className="space-y-4 py-4">
      ...
      <div>
        ...
        <div className="space-y-2">
          {product.image_url && (
            <img src={product.image_url} alt="Product preview" className="w-24 h-24 object-cover rounded" />
          )}
      ...
      <div>
        ...
        <Textarea
          ...
          onChange={(e) => setProduct({...product, precautions: e.target.value})}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={(checked) => setProduct({...product, is_prescription: checked})}
          />
